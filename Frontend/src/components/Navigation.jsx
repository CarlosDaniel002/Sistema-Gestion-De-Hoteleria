  ...
  return (
    <nav className="navbar bg-secundary navbar-expand-lg">
      <div className="container-fluid" id="NavPadding">
        <Link to="/Inicio" className="navbar-brand p-1" id="logo">
        ...
        <div className="collapse navbar-collapse" id="navmenu">
          <div className="navbar-nav">
            <Link to="/Reservacion" className="nav-link" id="SubMenu">
            ...
            <Link to="/Habitacion" className="nav-link" id="SubMenu">
            <FontAwesomeIcon icon={faBed} /> {' '}Habitaciones
            </Link>
            <Link to="/Categoria" className="nav-link" id="SubMenu">
            ...
            <div className="nav-link" id="herramienta">
              <div className="dropdown">
                ...
                <ul className="dropdown-menu">
                  ...
                  <li>
                    <Link to="/NuevoUsuario" className="dropdown-item text-start">
                     <FontAwesomeIcon icon={faUserPlus} />{' '}Nuevo Usuario
                    </Link>
                  </li>

                  <li>
                    <Link to="/CambiarContrasena" className="dropdown-item text-start">
                  ...
                  <li>
                    ...
                    <FontAwesomeIcon icon={faArrowRightFromBracket} />{' '} Cerrar Sesion
                    </Link>
                  </li>
