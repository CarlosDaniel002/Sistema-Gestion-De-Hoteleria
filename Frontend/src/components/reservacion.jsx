    ...
    <>
      ...
      <div className="row g-3" id="contenido">
        ...
        <div className="col-md-8">
          ...
          >
            {" "}
            <FontAwesomeIcon icon={faFileCirclePlus} /> Agregar Reservaciones
          </button>
          <ModalInsertar show={modalShow} onHide={() => setModalShow(false)} />

          <button
            onClick={() => setModalPagoShow(true)}
            className="btn btn-secondary btn-otros"
          >
            {" "}
          ...
          <ModalPago
            show={modalPagoShow}
            onHide={() => setModalPagoShow(false)}
          />

          <button
            onClick={() => setModalCInShow(true)}
            className="btn btn-outline-secondary btn-otros"
          >
            {" "}
